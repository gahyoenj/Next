...
// export const dynamicParams = false; // 이렇게 false로 설정하면 generateStaticParams로 내보내진 값외에는 url 파라미터 존재하지 않는다고 해석해서 다른 페이지들은 404로 보냄

export function generateStaticParams() {
  return [{ id: "1" }, { id: "2" }, { id: "3" }]; //해당 페이지가 static 페이지가 됨 강제로
}
